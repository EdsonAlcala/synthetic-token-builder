...
export const getUMAAbis = () => {
    ...
    interfaces.set("ExpiringMultiPartyCreator", getAbi('ExpiringMultiPartyCreator'))
...
export const getUMAAddresses = (networkId: number) => {
    ...
    addresses.set("FinancialContractAdmin", getAddress('FinancialContractAdmin', networkId))
    addresses.set("Store", getAddress('Store', networkId))
    addresses.set("Governor", getAddress('Governor', networkId))
    addresses.set("DesignatedVotingFactory", getAddress('DesignatedVotingFactory', networkId))
    ...
    addresses.set("IdentifierWhitelist", getAddress('IdentifierWhitelist', networkId))
    addresses.set("Voting", getAddress('Voting', networkId))
    addresses.set("OptimisticOracle", getAddress('OptimisticOracle', networkId))
    addresses.set("ExpiringMultiPartyLib", getAddress('ExpiringMultiPartyLib', networkId))
    addresses.set("ExpiringMultiPartyCreator", getAddress('ExpiringMultiPartyCreator', networkId))
