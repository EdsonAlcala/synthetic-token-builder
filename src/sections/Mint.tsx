...
export const Mint: React.FC<{}> = () => {
  ...
  if (empState && collateralState && syntheticState && empAddress && signer) {
    ...
    const minSponsorTokensFromWei = parseFloat(
      fromWei(minSponsorTokens, syntheticdecimals)
    );
    const collateralRequirementFromWei = parseFloat(
      fromWei(collateralRequirement, collateralDecimals)
    );
    ...
    return (
      <Box>
              ...
              validate={(values) => {
                return new Promise((resolve, reject) => {
                  ...
                  if (!values.collateralAmount) {
                    ...
                    values.collateralAmount / values.syntheticTokens <
                    minSponsorTokensFromWei / 100
                  ) {
        ...
        <SuccessMessage show={successful}>
          You have successfully minted new synthetic tokens.
        </SuccessMessage>
