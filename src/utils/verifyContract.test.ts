...
describe("Verify Contract Tests", () => {
    ...
    beforeAll(async () => {
        ...
        const provider = new ethers.providers.AlchemyProvider(NETWORK.toLowerCase(), alchemyKey)
        ...
        // // deploy contract
        expandedERC20Interface = new ethers.utils.Interface(ExpandedERC20Artifact.abi)
        const expandedERC20Bytecode = ExpandedERC20Artifact.bytecode
        const expandedERC20Factory = new ethers.ContractFactory(expandedERC20Interface, expandedERC20Bytecode, newWalletInstance)
    ...
    test('verifyOnEtherscan', async () => {
        ...
        console.log("expandedERC20Interface.encodeDeploy", expandedERC20Interface.encodeDeploy(["EdToken", "EdToken", 18]),)
        const parameters: VerificationParameters = {
            ...
            contractArguments: expandedERC20Interface.encodeDeploy(["EdToken", "EdToken", 18]),
            sourceCode: "",
            network
        }
