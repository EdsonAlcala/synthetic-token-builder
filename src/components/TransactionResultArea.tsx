...
export const TransactionResultArea: React.FC<TransactionResultAreaProps> = ({ hash, error, success }) => {
                    ...
                    <Box>
                        <Link href={getEtherscanUrl(hash)} target="_blank" rel="noopener noreferrer">
                            <span style={{ fontSize: '1em', display: 'inline-flex', alignItems: 'center', marginTop: '0.5em' }}>
                                View on Etherscan<ArrowUpRight color="black" style={{ marginLeft: "0.2em", fontSize: '1em' }} />
                            </span>
                        </Link>
                    </Box>
                </React.Fragment>
